...
namespace PRoCon.Controls.ServerSettings.MOHW
{
    using Core;
    using Core.Remote;
    public partial class uscServerSettingsConfigurationMOHW : uscServerSettings
    {
        ...
        public uscServerSettingsConfigurationMOHW()
        {
            InitializeComponent();
            ...
            */
            // this.chkSettingsAggressiveJoin.Enabled = false;
